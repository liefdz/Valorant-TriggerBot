...
def print_banner(bot: triggerBot) -> None:
    os.system("cls")
    print(Style.BRIGHT + Fore.CYAN + "Ousmane Valorant TriggerBot v1.0.0" + Style.RESET_ALL)
    print("===== Control =====    ")
    print("Activation key        :", Fore.YELLOW + TRIGGER_KEY + Style.RESET_ALL)
    print("Mode Switching Key    :", Fore.YELLOW + SWITCH_KEY + Style.RESET_ALL)
    print("Setting Capture Area  :", Fore.YELLOW + GRABZONE_KEY_UP + "/" + GRABZONE_KEY_DOWN + Style.RESET_ALL)
    print("==== Information ===   ")

    print("Mode                  :", Fore.CYAN + mods[bot.mode] + Style.RESET_ALL)
    print("Capture Area         :", Fore.CYAN + str(GRABZONE) + "x" + str(GRABZONE) + Style.RESET_ALL)
    print("Trigger Status       :", (Fore.GREEN if bot.toggled else Fore.RED) + ("Open" if bot.toggled else "Closed") + Style.RESET_ALL)
    print("Bunny Status         :", (Fore.GREEN if bot._bunny else Fore.RED) + ("Open" if bot._bunny else "Closed") + Style.RESET_ALL)
    print("Final Reaction Time  :", Fore.CYAN + str(bot.last_reac) + Style.RESET_ALL + " ms ("+str((bot.last_reac)/(GRABZONE*GRABZONE))+"ms/pix)")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
